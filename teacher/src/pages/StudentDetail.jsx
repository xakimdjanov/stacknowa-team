  ...
  return (
    <div className="p-8 max-w-[1400px] mx-auto min-h-screen">
      ...
      <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-6 mb-6 flex items-center justify-between">
        ...
        <span className="bg-green-100 text-green-700 text-[10px] font-bold px-4 py-1.5 rounded-full uppercase tracking-wider">ACTIVE</span>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        ...
        <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm">
          ...
          <p className="text-xs font-bold text-green-500">↑ 3.4%</p>
        </div>
        <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-8">
        ...
        <div className="lg:col-span-2 bg-white rounded-2xl border border-slate-200 shadow-sm p-8">
          ...
          <div className="h-40 relative flex items-end justify-between px-4 border-b border-slate-100 pb-8 mb-8">
            ...
            <div className="w-16 h-1 bg-blue-600 rounded-full mb-[20%]"></div>
            <div className="w-16 h-1 bg-blue-600 rounded-full mb-[30%]"></div>
            <div className="w-16 h-1 bg-blue-600 rounded-full mb-[25%]"></div>
            <div className="w-16 h-1 bg-blue-600 rounded-full mb-[40%]"></div>
            <div className="w-16 h-1 bg-blue-600 rounded-full mb-[50%]"></div>
          </div>
