    ...
    <div className="min-h-screen flex flex-col lg:flex-row bg-white">
      ...
      <div className="w-full lg:w-1/2 p-6 sm:p-8 lg:p-14 flex flex-col justify-between bg-white overflow-y-auto min-h-screen lg:min-h-0">
        <div className="max-w-md w-full mx-auto my-auto py-6">
          ...
          <button
            type="button"
            className="w-full border border-slate-200 hover:bg-slate-50 text-slate-700 font-semibold py-2.5 px-4 rounded-xl flex items-center justify-center space-x-2.5 transition-all text-xs"
          >
          ...
          <div className="mt-5 text-center space-y-1">
            <p className="text-[11px] text-slate-400">Keyingi qadam: O'qituvchingiz guruhiga ulanish</p>
