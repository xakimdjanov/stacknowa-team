    ...
    <div className="min-h-screen flex flex-col lg:flex-row bg-white">
        ...
        <div className="my-auto py-10 z-10 max-w-lg mx-auto text-center lg:text-left">
          <div className="rounded-3xl overflow-hidden shadow-2xl border-4 border-white/20 mb-8 transform hover:scale-[1.01] transition-transform bg-white/10">
            <img 
              ...
              alt="Talabalar uchun AI vositalari" 
      ...
      <div className="lg:w-1/2 p-8 lg:p-16 flex flex-col justify-between bg-white">
        <div className="max-w-md w-full mx-auto my-auto py-8">
          ...
          <button
            type="button"
            className="w-full border border-slate-200 hover:bg-slate-50 text-slate-700 font-semibold py-3 px-4 rounded-xl flex items-center justify-center space-x-2.5 transition-all text-sm"
          >
        ...
        <div className="flex items-center justify-center space-x-2 text-[11px] text-emerald-700 font-medium pt-4">
          ...
          <span>Sizning hisobingiz va topshiriqlaringiz to'liq xavfsiz</span>
        </div>
      </div>
    </div>
  );
